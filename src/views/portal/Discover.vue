      ...
      <div class="max-w-[1600px] mx-auto">
        ...
        <div class="flex items-end justify-between mb-10 flex-wrap gap-10">
          ...
          <div class="flex items-center gap-3 flex-wrap">
            ...
            <!-- 配置按钮 -->
            <button @click="showConfigModal = true" class="group outline-none" title="Registry Config">
              <BaseAvatar 
                size="32px"
                shape="square"
                border="thin"
                border-style="dashed"
                bg-color="bg-white"
                border-color="border-zinc-200 group-hover:border-zinc-900"
                text-color="text-zinc-300 group-hover:text-zinc-900"
                class="transition-all"
              >
                <svg class="w-4 h-4 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
